...
use crate::net::fetch::fetch_params::{
    ConsumePreloadedResources, FetchParams, SharedPreloadedResources,
};
use crate::net::filemanager_thread::FileManager;
use crate::net::http_loader::{
...
use crate::net::protocols::{ProtocolRegistry, is_url_potentially_trustworthy};
use crate::net::request_interceptor::RequestInterceptor;
use crate::net::subresource_integrity::is_response_integrity_valid;
...
pub struct FetchContext {
    ...
    pub hppr_state: Arc<crate::net::hppr_pool::HpprAsyncState>,
}
