...
use crate::hppr::join_fixture::get_join_fixture_state;
use crate::hppr::url::HAVIAddress;
use crate::hppr::util::{html_escape, resolve_route_endpoint, signing_to_verifying_key};
...
fn render_join_page(
    ...
    crate::pages::page_shell::render_page("Join group - HAVI", css, &body)
}
