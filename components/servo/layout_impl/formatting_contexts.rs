...
use super::dom::WeakLayoutBox;
use super::dom_traversal::{Contents, NodeAndStyleInfo, NonReplacedContents};
use super::flexbox::FlexContainer;
use super::flow::BlockFormattingContext;
use super::fragment_tree::{BaseFragmentInfo, FragmentFlags};
use super::layout_box_base::{
    CacheableLayoutResult, CacheableLayoutResultAndInputs, LayoutBoxBase,
};
use super::positioned::PositioningContext;
use super::replaced::ReplacedContents;
use super::sizing::{
    self, ComputeInlineContentSizes, ContentSizes, InlineContentSizesResult, LazySize,
};
use super::style_ext::{AspectRatio, Display, DisplayInside, LayoutStyle};
use super::svg::layout::SVGRootContents;
use super::table::Table;
use super::taffy::TaffyContainer;
use super::{
...
pub(crate) struct IndependentFormattingContext {
    pub(in crate::layout) base: LayoutBoxBase,
...
#[derive(Debug, MallocSizeOf)]
pub(in crate::layout) enum IndependentFormattingContextContents {
...
/// The baselines of a layout or a [`super::fragment_tree::BoxFragment`]. Some layout
...
impl IndependentFormattingContext {
    ...
    pub(super) fn attached_to_tree(&self, layout_box: WeakLayoutBox) {
        match &self.contents {
            IndependentFormattingContextContents::Replaced(_, widget) => {
                if let Some(widget) = widget {
