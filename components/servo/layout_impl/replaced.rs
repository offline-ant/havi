...
use super::cell::ArcRefCell;
use super::context::{LayoutContext, LayoutImageCacheResult};
use super::dom::NodeExt;
use super::fragment_tree::{
    BaseFragment, BaseFragmentInfo, CollapsedBlockMargins, Fragment, IFrameFragment, ImageFragment,
};
use super::geom::{LogicalVec2, PhysicalPoint, PhysicalRect, PhysicalSize};
use super::layout_box_base::{CacheableLayoutResult, LayoutBoxBase};
use super::positioned::PositioningContext;
use super::sizing::{
    ComputeInlineContentSizes, InlineContentSizesResult, LazySize, SizeConstraint,
};
use super::style_ext::{AspectRatio, Clamp, ComputedValuesExt, LayoutStyle};
use super::svg::layout::build_svg_root_fragment_from_tree;
use super::svg::parse::{
    compute_svg_image_intrinsic_sizes, extract_svg_root_metadata, parse_svg_tree,
};
use super::{ConstraintSpace, ContainingBlock};
...
impl NaturalSizes {
    ...
    pub(crate) fn from_svg_image_intrinsic_sizes(
        intrinsic: super::svg::parse::SVGImageIntrinsicSizes,
    ) -> Self {
        Self {
        ...
        match &self.kind {
            ReplacedContentKind::Image(image_info) => match image_info.image.as_ref() {
                Some(Image::Raster(raster_image)) => vec![Fragment::Image(ArcRefCell::new(
                    ImageFragment {
                        ...
                        source_kind: super::fragment_tree::ImageFragmentSourceKind::Raster,
                        image_revision: 0,
                        source_width: 0,
                        source_height: 0,
                        source_data: None,
            ...
            ReplacedContentKind::Video(video_info) => {
                vec![Fragment::Image(ArcRefCell::new(ImageFragment {
                    ...
                    source_kind: super::fragment_tree::ImageFragmentSourceKind::Video,
                    image_revision: 0,
                    source_width: 0,
                    source_height: 0,
                    source_data: None,
            ...
            ReplacedContentKind::Canvas(canvas_info) => {
                ...
                vec![Fragment::Image(ArcRefCell::new(ImageFragment {
                    ...
                    source_kind: super::fragment_tree::ImageFragmentSourceKind::Canvas,
                    image_revision: 0,
                    source_width: 0,
                    source_height: 0,
                    source_data: None,
