...
use super::dom_traversal::Contents;
...
use super::sizing::{Size, Sizes};
use super::table::TableLayoutStyle;
use super::{ContainingBlock, IndefiniteContainingBlock};
...
impl DisplayGeneratingBox {
    ...
    pub(in crate::layout) fn used_value_for_contents(&self, contents: &Contents) -> Self {
