...
use crate::layout::layout_box_base::{CacheableLayoutResult, LayoutBoxBase};
use crate::layout::positioned::{
    AbsolutelyPositionedBox, PositioningContext, PositioningContextLength,
};
use crate::layout::sizing::{
    self, ComputeInlineContentSizes, ContentSizes, InlineContentSizesResult, LazySize, Size,
    SizeConstraint, Sizes,
};
use crate::layout::style_ext::{AspectRatio, ContentBoxSizesAndPBM, LayoutStyle, PaddingBorderMargin};
use crate::layout::{
...
pub(in crate::layout) use construct::{BlockContainerBuilder, BlockLevelCreator};
pub(crate) use root::BoxTree;


#[derive(Debug, MallocSizeOf)]
pub(in crate::layout) struct BlockFormattingContext {
    pub(in crate::layout) contents: BlockContainer,
    pub(in crate::layout) contains_floats: bool,
}

#[derive(Debug, MallocSizeOf)]
pub(in crate::layout) enum BlockContainer {
...
#[derive(Debug, MallocSizeOf)]
pub(in crate::layout) enum BlockLevelBox {
...
impl BlockLevelBox {
    ...
    pub(in crate::layout) fn with_base_mut<T>(&mut self, callback: impl FnOnce(&mut LayoutBoxBase) -> T) -> T {
        match self {
            BlockLevelBox::Independent(independent_formatting_context) => {
...
impl BlockFormattingContext {
    ...
    #[inline]
    pub(in crate::layout) fn layout_style<'a>(&self, base: &'a LayoutBoxBase) -> LayoutStyle<'a> {
...
pub(in crate::layout) fn layout_in_flow_non_replaced_block_level_same_formatting_context(
    layout_context: &LayoutContext,
    positioning_context: &mut PositioningContext,
    containing_block: &ContainingBlock,
    base: &LayoutBoxBase,
