...
use super::quotes::quotes_for_lang;
use super::replaced::ReplacedContents;
use super::style_ext::{Display, DisplayGeneratingBox, DisplayInside, DisplayOutside};
...
#[derive(Debug)]
pub(in crate::layout) enum Contents {
...
#[derive(Debug)]
pub(in crate::layout) enum NonReplacedContents {
...
#[derive(Debug)]
pub(in crate::layout) enum PseudoElementContentItem {
    Text(String),
    Replaced(ReplacedContents),
}
