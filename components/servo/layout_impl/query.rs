...
use super::dom::NodeExt;
use super::flow::inline::construct::{TextTransformation, WhitespaceCollapse, capitalize_string};
use super::fragment_tree::{FragmentFlags, FragmentTree};
use super::geom::PhysicalRect;
use super::style_ext::ComputedValuesExt;
use super::svg::hit_test::{hit_test_svg_path, point_in_fill, point_near_stroke};
use super::svg::path::{svg_path_point_and_tangent_at_length, svg_path_total_length};
use super::svg::transform::then_svg_transform;
...
fn transform_svg_rect(
    ...
    let max_y = transformed
        ...
        .fold(f32::NEG_INFINITY, f32::max);
    PhysicalRect::new(
        super::geom::PhysicalPoint::new(Au::from_f32_px(min_x), Au::from_f32_px(min_y)),
        super::geom::PhysicalSize::new(
    ...
    let rect = match generation.kind(fragment_id) {
        published::FragmentKind::Box(box_fragment) | published::FragmentKind::Float(box_fragment) => {
            if box_fragment
                .base
                .style
                .is_inline_box(super::fragment_tree::FragmentFlags::from_bits_retain(
            ...
            let mut rect = if matches!(
                ...
                padding_rect.origin = super::geom::PhysicalPoint::new(
                    box_fragment.border.left,
                    box_fragment.border.top,
                );
                padding_rect
            };
            rect.origin = super::geom::PhysicalPoint::new(
                rect.origin.x,
                rect.origin.y,
            );
            rect
...
fn transform_svg_rect_scalar(rect: published::SVGRect, transform: published::SVGTransform) -> published::SVGRect {
    ...
    published::SVGRect::new(
        ...
        super::geom::PhysicalSize::new(max_x - min_x, max_y - min_y),
    )
}
...
mod tests {
    ...
    use super::geom::{PhysicalPoint, PhysicalRect, PhysicalSize};
            ...
            published::FragmentNode {
                ...
                kind: published::FragmentKind::SVGViewport(published::SVGViewportFragment {
                    ...
                    viewport_rect: published::SVGRect::new(
                        ...
                        super::geom::PhysicalSize::new(200.0, 100.0),
                    ),
                    view_box_rect: None,
            ...
            published::FragmentNode {
                ...
                kind: published::FragmentKind::SVGViewport(published::SVGViewportFragment {
                    ...
                    view_box_rect: Some(published::SVGRect::new(
                        published::SVGPoint::new(0.0, 0.0),
                        super::geom::PhysicalSize::new(100.0, 100.0),
                    )),
