...
use crate::layout::dom_traversal::{
    Contents, NodeAndStyleInfo, NonReplacedContents, TraversalHandler,
};
use crate::layout::flow::{BlockContainerBuilder, BlockFormattingContext};
...
use crate::layout::style_ext::{DisplayGeneratingBox, DisplayLayoutInternal};
...
pub(in crate::layout) enum AnonymousTableContent<'dom> {
...
impl Table {
    ...
    pub(in crate::layout) fn construct_anonymous<'dom>(
        context: &LayoutContext,
