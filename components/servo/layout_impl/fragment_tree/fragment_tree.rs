...
use crate::layout::context::{ImageResolver, LayoutContext};
use crate::layout::fragment_tree::{BaseFragmentInfo, FragmentFlags};
use crate::layout::geom::{PhysicalPoint, PhysicalRect, PhysicalSize};
use crate::layout::positioned::PositioningContext;
use crate::layout::svg::layout::build_svg_root_fragment_from_tree_with_text_context;
use crate::layout::svg::parse::{
    compute_svg_image_intrinsic_sizes, extract_svg_root_metadata, parse_svg_tree,
};
use crate::layout::svg::text::SVGTextLayoutContext;
...
fn convert_image_fragment(fragment: &ImageFragment) -> published::ImageFragment {
    ...
    published::ImageFragment {
        ...
        source_kind: match fragment.source_kind {
            crate::layout::fragment_tree::ImageFragmentSourceKind::Raster => {
                published::ImageSourceKind::Raster
            }
            crate::layout::fragment_tree::ImageFragmentSourceKind::Canvas => {
                published::ImageSourceKind::Canvas
            }
            crate::layout::fragment_tree::ImageFragmentSourceKind::Video => {
...
fn fragment_key<T>(fragment: &crate::layout::cell::ArcRefCell<T>) -> usize {
