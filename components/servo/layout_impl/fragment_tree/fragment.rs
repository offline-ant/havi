...
use crate::layout::flow::inline::line::TextRunOffsets;
use crate::layout::geom::{LogicalSides, PhysicalRect};
...
pub enum Fragment {
    ...
    /// out by the [super::flow::float::SequentialLayoutState] of their
...
pub struct SVGViewportFragment {
    ...
    pub resource_graph: Option<crate::layout::svg::resources::SVGResourceGraph>,
