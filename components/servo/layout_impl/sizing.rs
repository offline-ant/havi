...
use super::style_ext::{AspectRatio, Clamp, ComputedValuesExt, ContentBoxSizesAndPBM, LayoutStyle};
use super::{ConstraintSpace, IndefiniteContainingBlock, LogicalVec2};
...
pub(in crate::layout) fn outer_inline(
    base: &LayoutBoxBase,
