...
pub(crate) mod dom;
pub(crate) mod dom_traversal;
mod flexbox;
pub mod flow;
pub(crate) mod formatting_contexts;
pub mod fragment_tree;
pub mod geom;
pub(crate) mod layout_box_base;
mod layout_impl;
pub(crate) mod taffy;
#[macro_use]
...
use self::geom::LogicalVec2;
use self::sizing::SizeConstraint;
use self::style_ext::AspectRatio;
...
pub(crate) struct DefiniteContainingBlock<'a> {
    size: LogicalVec2<Au>,
    style: &'a ComputedValues,
}
...
/// Data that is propagated from ancestors to descendants during [`super::flow::BoxTree`]
...
pub(crate) struct PropagatedBoxTreeData {
