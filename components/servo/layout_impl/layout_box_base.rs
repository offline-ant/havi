...
use super::dom::{LayoutBox, WeakLayoutBox};
use super::formatting_contexts::Baselines;
use super::fragment_tree::{BaseFragmentInfo, CollapsedBlockMargins, Fragment, SpecificLayoutInfo};
use super::positioned::PositioningContext;
use super::sizing::{ComputeInlineContentSizes, InlineContentSizesResult, SizeConstraint};
use super::{ConstraintSpace, ContainingBlockSize};
...
#[derive(MallocSizeOf)]
pub(in crate::layout) struct LayoutBoxBase {
    ...
    pub(super) parent_box: Option<WeakLayoutBox>,
}
...
impl LayoutBoxBase {
    ...
    #[expect(unused)]
    pub(super) fn parent_box(&self) -> Option<LayoutBox> {
