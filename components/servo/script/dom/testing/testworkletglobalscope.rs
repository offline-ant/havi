...
use crate::script::dom::bindings::codegen::Bindings::TestWorkletGlobalScopeBinding;
use crate::script::dom::bindings::codegen::GenericBindings::TestWorkletGlobalScopeBinding::TestWorkletGlobalScopeMethods;
...
use crate::script::dom::workletglobalscope::{WorkletGlobalScope, WorkletGlobalScopeInit};
