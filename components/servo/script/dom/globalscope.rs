...
use crate::script::dom::bindings::cell::{DomRefCell, RefMut};
use crate::script::dom::bindings::codegen::GenericBindings::BroadcastChannelBinding::BroadcastChannelMethods;
use crate::script::dom::bindings::codegen::GenericBindings::EventSourceBinding::EventSource_Binding::EventSourceMethods;
use crate::script::dom::bindings::codegen::Bindings::FunctionBinding::Function;
use crate::script::dom::bindings::codegen::Bindings::NotificationBinding::NotificationPermissionCallback;
use crate::script::dom::bindings::codegen::Bindings::PermissionStatusBinding::{
...
use crate::script::dom::bindings::codegen::GenericBindings::WorkerGlobalScopeBinding::WorkerGlobalScopeMethods;
use crate::script::dom::bindings::conversions::{root_from_object, root_from_object_static};
#[cfg(feature = "js_backtrace")]
use crate::script::dom::bindings::error::LAST_EXCEPTION_BACKTRACE;
...
use crate::script::dom::bindings::settings_stack::{entry_global, incumbent_global};
...
use crate::script::dom::bindings::weakref::{DOMTracker, WeakRef};
use crate::script::dom::blob::Blob;
use crate::script::dom::broadcastchannel::BroadcastChannel;
use crate::script::dom::crypto::Crypto;
use crate::script::dom::dedicatedworkerglobalscope::{
    DedicatedWorkerControlMsg, DedicatedWorkerGlobalScope,
};
use crate::script::dom::errorevent::ErrorEvent;
use crate::script::dom::event::{Event, EventBubbles, EventCancelable};
use crate::script::dom::eventsource::EventSource;
use crate::script::dom::eventtarget::EventTarget;
use crate::script::dom::file::File;
use crate::script::dom::global_scope_script_execution::{compile_script, evaluate_script};
use crate::script::dom::idbfactory::IDBFactory;
use crate::script::dom::messageport::MessagePort;
use crate::script::dom::paintworkletglobalscope::PaintWorkletGlobalScope;
use crate::script::dom::performance::performance::Performance;
use crate::script::dom::performance::performanceentry::EntryType;
use crate::script::dom::promise::Promise;
use crate::script::dom::readablestream::{CrossRealmTransformReadable, ReadableStream};
use crate::script::dom::reportingobserver::ReportingObserver;
use crate::script::dom::serviceworker::ServiceWorker;
use crate::script::dom::serviceworkerregistration::ServiceWorkerRegistration;
use crate::script::dom::stream::underlyingsourcecontainer::UnderlyingSourceType;
use crate::script::dom::stream::writablestream::CrossRealmTransformWritable;
use crate::script::dom::trustedtypepolicyfactory::TrustedTypePolicyFactory;
use crate::script::dom::types::{AbortSignal, CookieStore, DebuggerGlobalScope, MessageEvent};
#[cfg(feature = "webgpu")]
use crate::script::dom::webgpu::gpudevice::GPUDevice;
#[cfg(feature = "webgpu")]
use crate::script::dom::webgpu::identityhub::IdentityHub;
use crate::script::dom::window::Window;
use crate::script::dom::workerglobalscope::WorkerGlobalScope;
use crate::script::dom::workletglobalscope::WorkletGlobalScope;
use crate::script::fetch::{DeferredFetchRecordId, FetchGroup, QueuedDeferredFetchRecord};
use crate::script::messaging::{CommonScriptMsg, ScriptEventLoopReceiver, ScriptEventLoopSender};
use crate::script::microtask::Microtask;
use crate::script::network_listener::{FetchResponseListener, NetworkListener};
use crate::script::realms::{InRealm, enter_auto_realm, enter_realm};
use crate::script::script_module::{
    ImportMap, ModuleRequest, ModuleStatus, ResolvedModule, ScriptFetchOptions,
};
use crate::script::script_runtime::{CanGc, JSContext as SafeJSContext, ThreadSafeJSContext};
use crate::script::script_thread::{ScriptThread, with_script_thread};
use crate::script::task_manager::TaskManager;
use crate::script::task_source::SendableTaskSource;
use crate::script::timers::{
...
impl GlobalScope {
    ...
    pub(crate) fn report_an_exception(&self, cx: SafeJSContext, error: HandleValue, can_gc: CanGc) {
        ...
        let error_info = crate::script::dom::bindings::error::ErrorInfo::from_value(error, cx, can_gc);
        ...
        F: 'static + FnOnce(&mut js::context::JSContext, &GlobalScope),
    {
        ...
        let callback = crate::script::timers::OneshotTimerCallback::RunStepsAfterTimeout {
            // Step 1. timerKey
            timer_key,
