...
use crate::script::dom::bindings::codegen::Bindings::DOMRectReadOnlyBinding::{
...
use crate::script::dom::domrectreadonly::{DOMRectReadOnly, create_a_domrectreadonly_from_the_dictionary};
