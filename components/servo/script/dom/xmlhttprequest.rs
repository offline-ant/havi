...
use crate::script::body::{BodySource, Extractable, ExtractedBody, decode_to_utf16_with_bom_removal};
...
use crate::script::dom::bindings::codegen::Bindings::XMLHttpRequestBinding::{
    XMLHttpRequestMethods, XMLHttpRequestResponseType,
};
use crate::script::dom::bindings::codegen::UnionTypes::DocumentOrBlobOrArrayBufferViewOrArrayBufferOrFormDataOrStringOrURLSearchParams as DocumentOrXMLHttpRequestBodyInit;
...
use crate::script::dom::bindings::str::{ByteString, DOMString, USVString, is_token};
use crate::script::dom::blob::{Blob, normalize_type_string};
...
use crate::script::dom::xmlhttprequestupload::XMLHttpRequestUpload;
use crate::script::fetch::{FetchCanceller, RequestWithGlobalScope};
use crate::script::mime::{APPLICATION, CHARSET, HTML, MimeExt, TEXT, XML};
...
use crate::script::timers::{OneshotTimerCallback, OneshotTimerHandle};
