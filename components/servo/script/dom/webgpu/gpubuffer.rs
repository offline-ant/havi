...
use crate::webgpu::{Mapping, WebGPU, WebGPUBuffer, WebGPURequest};
use wgpu_core::device::HostMap;
use wgpu_core::resource::BufferAccessError;

use crate::script::conversions::Convert;
use crate::script::dom::bindings::buffer_source::DataBlock;
    ...
    fn MapAsync(
        ...
        *self.pending_map.borrow_mut() = Some(promise.clone());
        ...
        let host_map = match mode {
            ...
            _ => {
                self.device
                    .dispatch_error(crate::webgpu::Error::Validation(String::from(
