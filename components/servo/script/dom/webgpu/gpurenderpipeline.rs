...
use crate::script::dom::bindings::codegen::GenericBindings::WebGPUBinding::GPURenderPipelineMethods;
...
use crate::script::dom::webgpu::gpudevice::{GPUDevice, PipelineLayout};
