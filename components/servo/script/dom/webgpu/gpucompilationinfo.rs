...
use crate::webgpu::ShaderCompilationInfo;

use crate::script::dom::bindings::codegen::GenericBindings::WebGPUBinding::GPUCompilationInfoMethods;
...
use crate::script::dom::types::GPUCompilationMessage;
