...
use crate::script::script_runtime::JSContext as SafeJSContext;
use js::jsval::UndefinedValue;
use js::typedarray::ArrayBuffer;


use crate::script::body::decode_to_utf16_with_bom_removal;
use crate::script::dom::bindings::codegen::GenericBindings::HpprPacketBinding::HpprPacketMethods;
...
impl HpprPacketMethods<crate::DomTypeHolder> for HpprPacket {
    ...
    fn Text(&self) -> Result<crate::script::dom::bindings::str::USVString, Error> {
        match std::str::from_utf8(self.data()) {
            Ok(text) => Ok(crate::script::dom::bindings::str::USVString(text.to_string())),
