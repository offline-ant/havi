...
use crate::script::dom::bindings::codegen::Bindings::CommandEventBinding;
use crate::script::dom::bindings::codegen::GenericBindings::CommandEventBinding::CommandEventMethods;
...
use crate::script::dom::types::Window;
