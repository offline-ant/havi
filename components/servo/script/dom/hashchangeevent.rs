...
use crate::script::dom::bindings::codegen::Bindings::HashChangeEventBinding;
use crate::script::dom::bindings::codegen::GenericBindings::HashChangeEventBinding::HashChangeEventMethods;
