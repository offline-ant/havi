...
use crate::script::dom::bindings::conversions::{ToJSValConvertible, root_from_handleobject};
use crate::script::dom::bindings::error::{Error, Fallible, throw_dom_exception};
use crate::script::dom::bindings::inheritance::Castable;
use crate::script::dom::bindings::proxyhandler::set_property_descriptor;
use crate::script::dom::bindings::reflector::{DomGlobal, DomObject, Reflector};
...
use crate::script::dom::bindings::utils::get_array_index_from_id;
use crate::script::dom::dissimilaroriginwindow::DissimilarOriginWindow;
...
impl WindowProxyHandler {
    ...
    pub(crate) fn new_window_proxy(
        &self,
        cx: &crate::script::script_runtime::JSContext,
