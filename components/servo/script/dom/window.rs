...
use crate::script::dom::bindings::codegen::GenericBindings::HistoryBinding::History_Binding::HistoryMethods;
use crate::script::dom::bindings::codegen::Bindings::ImageBitmapBinding::{
    ImageBitmapOptions, ImageBitmapSource,
};
use crate::script::dom::bindings::codegen::GenericBindings::MediaQueryListBinding::MediaQueryList_Binding::MediaQueryListMethods;
use crate::script::dom::bindings::codegen::Bindings::ReportingObserverBinding::Report;
use crate::script::dom::bindings::codegen::Bindings::RequestBinding::{RequestInfo, RequestInit};
use crate::script::dom::bindings::codegen::Bindings::VoidFunctionBinding::VoidFunction;
...
use crate::script::dom::bindings::error::{
...
use crate::script::dom::bindings::reflector::{DomGlobal, DomObject};
use crate::script::dom::bindings::root::{Dom, DomRoot, MutNullableDom};
use crate::script::dom::bindings::str::{DOMString, USVString};
use crate::script::dom::bindings::structuredclone;
use crate::script::dom::bindings::trace::{CustomTraceable, JSTraceable, RootedTraceableBox};
use crate::script::dom::bindings::utils::GlobalStaticData;
use crate::script::dom::bindings::weakref::DOMTracker;
#[cfg(feature = "bluetooth")]
use crate::script::dom::bluetooth::BluetoothExtraPermissionData;
use crate::script::dom::cookiestore::CookieStore;
use crate::script::dom::crypto::Crypto;
use crate::script::dom::csp::GlobalCspReporting;
use crate::script::dom::css::cssstyledeclaration::{
    CSSModificationAccess, CSSStyleDeclaration, CSSStyleOwner,
};
use crate::script::dom::customelementregistry::CustomElementRegistry;
use crate::script::dom::document::{
...
use crate::script::dom::fetchlaterresult::FetchLaterResult;
use crate::script::dom::globalscope::GlobalScope;
use crate::script::dom::address::Address;
use crate::script::dom::history::History;
use crate::script::dom::hpprclient::HpprClient;
use crate::script::dom::hpprpacket::HpprPacket;
use crate::script::dom::hpprresolveresult::HpprResolveResult;
...
use crate::script::dom::idbfactory::IDBFactory;
use crate::script::dom::inputevent::HitTestResult;
use crate::script::dom::location::Location;
use crate::script::dom::medialist::MediaList;
use crate::script::dom::mediaquerylist::{MediaQueryList, MediaQueryListMatchState};
use crate::script::dom::mediaquerylistevent::MediaQueryListEvent;
use crate::script::dom::messageevent::MessageEvent;
use crate::script::dom::navigator::Navigator;
use crate::script::dom::node::{
    Node, NodeDamage, NodeTraits, ShadowIncluding, from_untrusted_node_address,
};
use crate::script::dom::performance::performance::Performance;
use crate::script::dom::promise::Promise;
use crate::script::dom::reportingendpoint::{ReportingEndpoint, SendReportsToEndpoints};
use crate::script::dom::reportingobserver::ReportingObserver;
use crate::script::dom::screen::Screen;
use crate::script::dom::scrolling_box::{ScrollingBox, ScrollingBoxSource};
use crate::script::dom::selection::Selection;
use crate::script::dom::shadowroot::ShadowRoot;
use crate::script::dom::storage::Storage;
#[cfg(feature = "bluetooth")]
use crate::script::dom::testrunner::TestRunner;
use crate::script::dom::trustedtypepolicyfactory::TrustedTypePolicyFactory;
use crate::script::dom::types::{ImageBitmap, MouseEvent, UIEvent};
use crate::script::dom::useractivation::UserActivationTimestamp;
use crate::script::dom::visualviewport::{VisualViewport, VisualViewportChanges};
#[cfg(feature = "webgpu")]
use crate::script::dom::webgpu::identityhub::IdentityHub;
use crate::script::dom::windowproxy::{WindowProxy, WindowProxyHandler};
use crate::script::dom::worklet::Worklet;
use crate::script::dom::workletglobalscope::WorkletGlobalScopeType;
use crate::script::layout_image::fetch_image_for_layout;
use crate::script::messaging::{MainThreadScriptMsg, ScriptEventLoopReceiver, ScriptEventLoopSender};
use crate::script::microtask::{Microtask, UserMicrotask};
use crate::script::network_listener::{ResourceTimingListener, submit_timing};
use crate::script::realms::{InRealm, enter_realm};
use crate::script::script_runtime::{CanGc, JSContext as SafeJSContext, Runtime};
use crate::script::script_thread::ScriptThread;
use crate::script::script_window_proxies::ScriptWindowProxies;
use crate::script::task_source::SendableTaskSource;
use crate::script::timers::{IsInterval, TimerCallback};
use crate::script::unminify::unminified_path;
use crate::script::webdriver_handlers::{find_node_by_unique_id_in_document, jsval_to_webdriver};
use hppr_client::Signer;
use crate::script::{fetch, window_named_properties};

use crate::script::dom::envelopehpprclient::default_endpoint;
...
impl Window {
            ...
            .and_then(|sel| {
                ...
                if *start_node != *end_node {
                    ...
                    for node in start_node.following_nodes(doc_node) {
                        ...
                        if node.is::<crate::script::dom::text::Text>() {
    ...
    fn find_text_node_by_opaque(node: &Node, target: style::dom::OpaqueNode) -> Option<DomRoot<Node>> {
        if node.is::<crate::script::dom::text::Text>() && node.to_opaque() == target {
    ...
    pub(crate) fn text_node_at_point(
        ...
        let query_node = if node.is::<crate::script::dom::text::Text>() {
        ...
        if text_node.is::<crate::script::dom::text::Text>()
            && text_node
