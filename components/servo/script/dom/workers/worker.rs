...
use crate::script::dom::bindings::codegen::Bindings::WorkerBinding::{WorkerMethods, WorkerOptions};
use crate::script::dom::bindings::codegen::UnionTypes::TrustedScriptURLOrUSVString;
...
use crate::script::dom::workerglobalscope::prepare_workerscope_init;
use crate::script::realms::enter_auto_realm;
use crate::script::script_runtime::{CanGc, ThreadSafeJSContext};
