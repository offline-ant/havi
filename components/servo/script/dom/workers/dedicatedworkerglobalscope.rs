...
use crate::script::devtools;
use crate::script::dom::abstractworker::{MessageData, SimpleWorkerErrorHandler, WorkerScriptMsg};
use crate::script::dom::abstractworkerglobalscope::{WorkerEventLoopMethods, run_worker_event_loop};
use crate::script::dom::bindings::cell::DomRefCell;
use crate::script::dom::bindings::codegen::Bindings::DedicatedWorkerGlobalScopeBinding;
use crate::script::dom::bindings::codegen::GenericBindings::DedicatedWorkerGlobalScopeBinding::DedicatedWorkerGlobalScopeMethods;
...
use crate::script::dom::bindings::error::{ErrorInfo, ErrorResult};
...
use crate::script::dom::bindings::trace::{CustomTraceable, RootedTraceableBox};
use crate::script::dom::csp::Violation;
...
use crate::script::dom::types::DebuggerGlobalScope;
#[cfg(feature = "webgpu")]
use crate::script::dom::webgpu::identityhub::IdentityHub;
use crate::script::dom::worker::{TrustedWorkerAddress, Worker};
use crate::script::dom::workerglobalscope::{ScriptFetchContext, WorkerGlobalScope};
...
use crate::script::script_runtime::ScriptThreadEventCategory::WorkerEvent;
use crate::script::script_runtime::{CanGc, JSContext as SafeJSContext, Runtime, ThreadSafeJSContext};
use crate::script::task_queue::{QueuedTask, QueuedTaskConversion, TaskQueue};
use crate::script::task_source::{SendableTaskSource, TaskSourceName};
