...
use crate::script::dom::bindings::codegen::GenericBindings::FileReaderSyncBinding::FileReaderSyncMethods;
...
use crate::script::dom::filereader::FileReaderSharedFunctionality;
