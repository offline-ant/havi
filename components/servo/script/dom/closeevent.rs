...
use crate::script::dom::bindings::codegen::Bindings::CloseEventBinding;
use crate::script::dom::bindings::codegen::GenericBindings::CloseEventBinding::CloseEventMethods;
