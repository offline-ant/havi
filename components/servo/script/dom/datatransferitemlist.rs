...
use crate::script::dom::bindings::codegen::GenericBindings::DataTransferItemListBinding::DataTransferItemListMethods;
...
use crate::script::dom::datatransferitem::DataTransferItem;
