...
pub(crate) mod base {
    ...
    pub(crate) use crate::script::script_runtime::JSContext as SafeJSContext;
}
...
pub(crate) mod module {
    ...
    pub(crate) use crate::script::dom::bindings::iterable::IterableIterator;
    pub(crate) use crate::script::dom::bindings::reflector::{
        DomObjectIteratorWrap, DomObjectWrap, Reflector,
    };
    pub(crate) use crate::script::dom::bindings::root::{Dom, Root};
    pub(crate) use crate::script::dom::bindings::weakref::WeakReferenceable;
}
