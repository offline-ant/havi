...
use mime::{self, Mime};
use crate::net::request::{CacheMode, CorsSettings, Destination, RequestBuilder, RequestId};
use crate::net::{FetchMetadata, FilteredMetadata, NetworkError, ResourceFetchTiming};
use script_bindings::conversions::SafeToJSValConvertible;
use servo_url::BrowserUrl;
use stylo_atoms::Atom;

use crate::script::dom::bindings::cell::DomRefCell;
use crate::script::dom::bindings::codegen::Bindings::EventSourceBinding::{
