...
use crate::script::dom::bindings::codegen::Bindings::MouseEventBinding;
use crate::script::dom::bindings::codegen::GenericBindings::MouseEventBinding::MouseEventMethods;
use crate::script::dom::bindings::codegen::GenericBindings::UIEventBinding::UIEventMethods;
...
use crate::script::dom::document::FireMouseEventType;
...
impl MouseEvent {
    ...
    pub(crate) fn to_pointer_event(
        ...
        event_type: &str,
        can_gc: CanGc,
    ) -> DomRoot<crate::script::dom::pointerevent::PointerEvent> {
