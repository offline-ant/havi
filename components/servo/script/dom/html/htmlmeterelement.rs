...
use crate::script::dom::bindings::codegen::GenericBindings::HTMLMeterElementBinding::HTMLMeterElementMethods;
...
use crate::script::dom::node::{BindContext, ChildrenMutation, Node, NodeTraits};
...
impl HTMLMeterElement {
    ...
    fn create_shadow_tree(&self, can_gc: CanGc) {
        ...
        let meter_value = Element::create(
            ...
            None,
            &document,
            crate::script::dom::element::ElementCreator::ScriptCreated,
            crate::script::dom::element::CustomElementCreationMode::Asynchronous,
            None,
            can_gc,
        );
        root.upcast::<Node>()
