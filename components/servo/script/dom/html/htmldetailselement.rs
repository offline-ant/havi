...
use crate::script::dom::bindings::codegen::GenericBindings::HTMLDetailsElementBinding::HTMLDetailsElementMethods;
...
use crate::script::dom::bindings::codegen::UnionTypes::ElementOrText;
...
use crate::script::dom::toggleevent::ToggleEvent;
...
impl HTMLDetailsElement {
    ...
    fn create_shadow_tree(&self, can_gc: CanGc) {
        ...
        self.upcast::<Node>()
            .dirty(crate::script::dom::node::NodeDamage::Other);
    }
