...
use crate::script::css::parser_context_for_anonymous_content;
...
use crate::script::dom::bindings::codegen::GenericBindings::DOMRectBinding::DOMRect_Binding::DOMRectMethods;
use crate::script::dom::bindings::codegen::GenericBindings::ElementBinding::Element_Binding::ElementMethods;
use crate::script::dom::bindings::codegen::GenericBindings::HTMLImageElementBinding::HTMLImageElementMethods;
use crate::script::dom::bindings::codegen::GenericBindings::MouseEventBinding::MouseEventMethods;
...
use crate::script::dom::bindings::root::{DomRoot, LayoutDom, MutNullableDom};
...
use crate::script::dom::html::htmlformelement::{FormControl, HTMLFormElement};
...
use crate::script::fetch::{RequestWithGlobalScope, create_a_potential_cors_request};
...
impl HTMLImageElement {
    ...
    fn fetch_image(&self, img_url: &BrowserUrl, cx: &mut js::context::JSContext) {
    ...
    fn handle_loaded_image(&self, image: Image, url: BrowserUrl, cx: &mut js::context::JSContext) {
...
impl HTMLImageElementMethods<crate::DomTypeHolder> for HTMLImageElement {
    ...
    fn SetCrossOrigin(&self, cx: &mut JSContext, value: Option<DOMString>) {
        set_cross_origin_attribute(self.upcast::<Element>(), value, CanGc::from_cx(cx));
    }
