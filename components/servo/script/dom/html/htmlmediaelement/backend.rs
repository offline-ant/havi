...
impl HTMLMediaElement {
    ...
    pub(super) fn install_media_controller(&self, controller: MediaController) {
        ...
        *self.media_controller.borrow_mut() = Some(controller);
        ...
        let task_source = self
            ...
            .to_sendable();
        let trusted_self = crate::script::dom::bindings::refcounted::Trusted::new(self);
    ...
    fn sync_mse_track_lists(&self, can_gc: CanGc) {
        ...
        while audio_track_list.len() < mc.audio_tracks.len() {
            ...
            let audio_track = crate::script::dom::audio::audiotrack::AudioTrack::new(
            ...
            let event = crate::script::dom::trackevent::TrackEvent::new(
                self.global().as_window(),
                atom!("addtrack"),
                false,
                false,
            ...
            event.upcast::<crate::script::dom::event::Event>().fire(
                audio_track_list.upcast::<crate::script::dom::eventtarget::EventTarget>(),
                can_gc,
            );
        }
        ...
        while video_track_list.len() < mc.video_tracks.len() {
            ...
            let video_track = crate::script::dom::videotrack::VideoTrack::new(
                self.global().as_window(),
            ...
            event.upcast::<crate::script::dom::event::Event>().fire(
                video_track_list.upcast::<crate::script::dom::eventtarget::EventTarget>(),
                can_gc,
            );
        }
    }
