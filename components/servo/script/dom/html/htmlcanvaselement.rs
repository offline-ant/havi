...
use crate::script::dom::bindings::codegen::Bindings::HTMLCanvasElementBinding::{
...
use crate::script::dom::bindings::codegen::UnionTypes::HTMLCanvasElementOrOffscreenCanvas as RootedHTMLCanvasElementOrOffscreenCanvas;
