...
//! =====================================
//!
//! * `dom::bindings::codegen::GenericBindings::FooBinding::FooMethods` for methods
//!   defined through IDL;
...
//! * implementing the
//!   `dom::bindings::codegen::GenericBindings::FooBinding::FooMethods` trait for
//!   `Foo`;
...
pub(crate) mod envelopehpprclient;
...
pub(crate) mod streampub;
pub(crate) mod streamsub;
