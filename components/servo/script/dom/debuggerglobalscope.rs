...
use crate::script::dom::bindings::codegen::Bindings::DebuggerInterruptEventBinding::{
...
use crate::script::dom::debuggerclearbreakpointevent::DebuggerClearBreakpointEvent;
use crate::script::dom::debuggerframeevent::DebuggerFrameEvent;
use crate::script::dom::debuggergetenvironmentevent::DebuggerGetEnvironmentEvent;
use crate::script::dom::debuggerinterruptevent::DebuggerInterruptEvent;
use crate::script::dom::debuggerresumeevent::DebuggerResumeEvent;
use crate::script::dom::debuggersetbreakpointevent::DebuggerSetBreakpointEvent;
...
use crate::script::script_thread::with_script_thread;
...
impl DebuggerGlobalScope {
    ...
    pub(crate) fn fire_add_debuggee(
        ...
        let debuggee_pipeline_id =
            crate::script::dom::pipelineid::PipelineId::new(self.upcast(), debuggee_pipeline_id, can_gc);
    ...
    pub(crate) fn fire_list_frames(
        ...
        let _realm = enter_realm(self);
        let pipeline_id =
            crate::script::dom::pipelineid::PipelineId::new(self.upcast(), pipeline_id, can_gc);
