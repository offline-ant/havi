...
use crate::script::dom::bindings::codegen::Bindings::HpprClientBinding::HpprAddOptions;
...
use crate::script::dom::hpprresult::HpprResult;
use crate::script::dom::hpprrepoinfo::HpprRepoInfo;
use crate::script::dom::promise::Promise;
use crate::script::dom::streampub::StreamPub;
use crate::script::dom::streamsub::StreamSub;
...
impl EnvelopeHpprClient {
    ...
    pub(crate) fn do_add(
        ...
        let data = options.data.as_ref().map(|d| {
            use crate::script::dom::bindings::codegen::UnionTypes::BlobOrArrayBufferOrArrayBufferViewOrUSVString;
            match d {
