...
use crate::script::dom::bindings::codegen::GenericBindings::ImageBitmapBinding::ImageBitmapMethods;
use crate::script::dom::bindings::codegen::GenericBindings::ImageBitmapRenderingContextBinding::ImageBitmapRenderingContextMethods;
