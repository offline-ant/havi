...
use crate::script::dom::bindings::codegen::Bindings::OffscreenCanvasBinding::{
...
use crate::script::dom::offscreencanvasrenderingcontext2d::OffscreenCanvasRenderingContext2D;
use crate::script::dom::promise::Promise;
use crate::script::realms::{AlreadyInRealm, InRealm};
