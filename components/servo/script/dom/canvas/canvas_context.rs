...
#[cfg(feature = "webgpu")]
use crate::script::dom::types::GPUCanvasContext;
use crate::script::dom::types::{
    CanvasRenderingContext2D, HTMLCanvasElement, ImageBitmapRenderingContext, OffscreenCanvas,
    OffscreenCanvasRenderingContext2D,
};

/// Non rooted variant of [`crate::script::dom::bindings::codegen::UnionTypes::HTMLCanvasElementOrOffscreenCanvas`]
...
/// Non rooted variant of [`crate::script::dom::bindings::codegen::Bindings::HTMLCanvasElementBinding::RenderingContext`]
#[cfg_attr(crown, crown::unrooted_must_root_lint::must_root)]
#[derive(Clone, JSTraceable, MallocSizeOf)]
...
/// Non rooted variant of [`crate::script::dom::bindings::codegen::Bindings::OffscreenCanvasBinding::OffscreenRenderingContext`]
#[cfg_attr(crown, crown::unrooted_must_root_lint::must_root)]
#[derive(Clone, JSTraceable, MallocSizeOf)]
