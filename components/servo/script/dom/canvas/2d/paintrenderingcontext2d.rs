...
use crate::script::dom::bindings::codegen::GenericBindings::PaintRenderingContext2DBinding::PaintRenderingContext2DMethods;
use crate::script::dom::bindings::codegen::UnionTypes::StringOrCanvasGradientOrCanvasPattern;
...
use crate::script::dom::bindings::reflector::{DomGlobal as _, reflect_dom_object};
