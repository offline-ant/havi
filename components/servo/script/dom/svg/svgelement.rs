...
use crate::script::dom::bindings::codegen::GenericBindings::SVGElementBinding::SVGElementMethods;
...
use crate::script::dom::node::{ChildrenMutation, Node, NodeDamage, NodeTraits, ShadowIncluding};
use crate::script::dom::svg::svganimatedvalueobjects::SVGAnimatedString;
...
impl VirtualMethods for SVGElement {
    ...
    fn attribute_mutated(&self, attr: &Attr, mutation: AttributeMutation, can_gc: CanGc) {
        ...
        for ancestor in self.upcast::<Node>().inclusive_ancestors(ShadowIncluding::No) {
            if let Some(svg_root) = ancestor.downcast::<crate::script::dom::svg::svgsvgelement::SVGSVGElement>() {
...
impl SVGElementMethods<crate::DomTypeHolder> for SVGElement {
    ...
    fn GetOwnerSVGElement(&self) -> Option<DomRoot<crate::script::dom::svg::svgsvgelement::SVGSVGElement>> {
        self.upcast::<Node>().ancestors().find_map(|ancestor| {
            ancestor
                .downcast::<crate::script::dom::svg::svgsvgelement::SVGSVGElement>()
