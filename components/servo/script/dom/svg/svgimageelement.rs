...
use crate::script::dom::bindings::codegen::GenericBindings::SVGImageElementBinding::SVGImageElementMethods;
...
use crate::script::dom::svg::svganimatedvalueobjects::{SVGAnimatedLength, SVGAnimatedPreserveAspectRatio, SVGAnimatedString};
