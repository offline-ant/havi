...
use crate::script::dom::bindings::codegen::GenericBindings::SVGGradientElementBinding::SVGGradientElementMethods;
...
use crate::script::dom::svg::svganimatedvalueobjects::{SVGAnimatedEnumeration, SVGAnimatedString, SVGAnimatedTransformList};
...
impl SVGGradientElementMethods<crate::DomTypeHolder> for SVGGradientElement {
    fn Href(&self) -> DomRoot<SVGAnimatedString> {
        self.href.or_init(|| SVGAnimatedString::new(&self.global(), self.upcast(), local_name!("href"), crate::script::script_runtime::CanGc::note()))
    }

    fn GradientUnits(&self) -> DomRoot<SVGAnimatedEnumeration> {
        self.gradient_units.or_init(|| SVGAnimatedEnumeration::new(&self.global(), self.upcast(), local_name!("gradientUnits"), GRADIENT_UNITS_VALUES, crate::script::script_runtime::CanGc::note()))
    }

    fn GradientTransform(&self) -> DomRoot<SVGAnimatedTransformList> {
        self.gradient_transform.or_init(|| SVGAnimatedTransformList::new(&self.global(), self.upcast(), local_name!("gradientTransform"), crate::script::script_runtime::CanGc::note()))
    }

    fn SpreadMethod(&self) -> DomRoot<SVGAnimatedEnumeration> {
        self.spread_method.or_init(|| SVGAnimatedEnumeration::new(&self.global(), self.upcast(), local_name!("spreadMethod"), SPREAD_METHOD_VALUES, crate::script::script_runtime::CanGc::note()))
    }
}
