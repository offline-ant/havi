...
use crate::script::dom::bindings::codegen::GenericBindings::SVGStopElementBinding::SVGStopElementMethods;
...
use crate::script::dom::svg::svganimatedvalueobjects::SVGAnimatedNumber;
...
pub(crate) struct SVGStopElement {
    ...
    offset: MutNullableDom<SVGAnimatedNumber>,
}
...
impl SVGStopElementMethods<crate::DomTypeHolder> for SVGStopElement {
    fn Offset(&self) -> DomRoot<SVGAnimatedNumber> {
        self.offset.or_init(|| SVGAnimatedNumber::new(&self.global(), self.upcast(), local_name!("offset"), CanGc::note()))
    }
}
