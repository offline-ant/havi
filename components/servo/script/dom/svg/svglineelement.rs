...
use crate::script::dom::bindings::codegen::GenericBindings::SVGLineElementBinding::SVGLineElementMethods;
...
impl SVGLineElementMethods<crate::DomTypeHolder> for SVGLineElement {
