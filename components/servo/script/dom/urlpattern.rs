...
use crate::script::dom::bindings::codegen::Bindings::URLPatternBinding;
use crate::script::dom::bindings::codegen::GenericBindings::URLPatternBinding::URLPatternMethods;
...
mod bindings_to_third_party {
    ...
    use crate::script::dom::urlpattern::USVStringOrURLPatternInit;
...
mod third_party_to_bindings {
    ...
    use crate::script::dom::bindings::codegen::UnionTypes::USVStringOrURLPatternInit;
