...
use crate::script::dom::bindings::inheritance::{ElementTypeId, HTMLElementTypeId, NodeTypeId};
use crate::script::dom::bindings::refcounted::Trusted;
use crate::script::dom::bindings::root::MutNullableDom;
use crate::script::dom::clipboardevent::ClipboardEventType;
use crate::script::dom::document::{FireMouseEventType, FocusInitiator};
use crate::script::dom::event::{EventBubbles, EventCancelable, EventComposed, EventFlags};
#[cfg(feature = "gamepad")]
use crate::script::dom::gamepad::gamepad::{Gamepad, contains_user_gesture};
#[cfg(feature = "gamepad")]
use crate::script::dom::gamepad::gamepadevent::GamepadEventType;
use crate::script::dom::inputevent::HitTestResult;
use crate::script::dom::interactive_element_command::InteractiveElementCommand;
use crate::script::dom::keyboardevent::KeyboardEvent;
use crate::script::dom::node::{self, Node, NodeTraits, ShadowIncluding};
use crate::script::dom::pointerevent::{PointerEvent, PointerId};
use crate::script::dom::scrolling_box::{ScrollAxisState, ScrollRequirement, ScrollingBoxAxis};
use crate::script::dom::types::{
...
use crate::script::drag_data_store::{DragDataStore, Kind, Mode};
...
impl DocumentEventHandler {
    ...
    fn begin_document_selection(&self, hit_test_result: &HitTestResult, can_gc: CanGc) {
        ...
        if hit_test_result
            ...
            .inclusive_ancestors(ShadowIncluding::Yes)
            .any(|n| {
                n.is::<crate::script::dom::html::htmlinputelement::HTMLInputElement>()
                    || n.is::<crate::script::dom::html::htmltextareaelement::HTMLTextAreaElement>()
            })
        {
            return;
        }
