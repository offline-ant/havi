...
use crate::script::dom::bindings::codegen::Bindings::XRTestBinding::{FakeXRDeviceInit, XRTestMethods};
...
use crate::script::dom::fakexrdevice::{FakeXRDevice, get_origin, get_views, get_world};
