...
use crate::script::dom::bindings::trace::HashMapTracedValues;
use crate::script::dom::bindings::buffer_source::create_buffer_source;
...
use crate::script::dom::bindings::codegen::Bindings::XRHitTestSourceBinding::{
    XRHitTestOptionsInit, XRHitTestTrackableType,
};
use crate::script::dom::bindings::codegen::GenericBindings::XRInputSourceArrayBinding::XRInputSourceArray_Binding::XRInputSourceArrayMethods;
use crate::script::dom::bindings::codegen::Bindings::XRReferenceSpaceBinding::XRReferenceSpaceType;
use crate::script::dom::bindings::codegen::Bindings::XRRenderStateBinding::{
    XRRenderStateInit, XRRenderStateMethods,
};
use crate::script::dom::bindings::codegen::Bindings::XRSessionBinding::{
    XREnvironmentBlendMode, XRFrameRequestCallback, XRInteractionMode, XRSessionMethods,
    XRVisibilityState,
};
use crate::script::dom::bindings::codegen::Bindings::XRSystemBinding::XRSessionMode;
...
use crate::script::dom::bindings::reflector::{reflect_dom_object, DomGlobal};
use crate::script::dom::bindings::root::{Dom, DomRoot, MutDom, MutNullableDom};
use crate::script::dom::bindings::utils::to_frozen_array;
...
use crate::script::dom::xrboundedreferencespace::XRBoundedReferenceSpace;
use crate::script::dom::xrframe::XRFrame;
use crate::script::dom::xrhittestsource::XRHitTestSource;
use crate::script::dom::xrinputsourcearray::XRInputSourceArray;
use crate::script::dom::xrinputsourceevent::XRInputSourceEvent;
use crate::script::dom::xrreferencespace::XRReferenceSpace;
use crate::script::dom::xrreferencespaceevent::XRReferenceSpaceEvent;
use crate::script::dom::xrrenderstate::XRRenderState;
use crate::script::dom::xrrigidtransform::XRRigidTransform;
use crate::script::dom::xrsessionevent::XRSessionEvent;
use crate::script::dom::xrspace::XRSpace;
use crate::script::realms::InRealm;
use crate::script::script_runtime::JSContext;
