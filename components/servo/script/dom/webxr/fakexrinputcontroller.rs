...
use crate::script::dom::bindings::codegen::Bindings::FakeXRDeviceBinding::FakeXRRigidTransformInit;
use crate::script::dom::bindings::codegen::Bindings::FakeXRInputControllerBinding::{
...
use crate::script::dom::fakexrdevice::get_origin;
