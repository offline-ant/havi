...
use crate::script::dom::bindings::codegen::GenericBindings::DOMParserBinding::DOMParserMethods;
use crate::script::dom::bindings::codegen::Bindings::DOMParserBinding::SupportedType::{
    Application_xhtml_xml, Application_xml, Image_svg_xml, Text_html, Text_xml,
};
use crate::script::dom::bindings::codegen::Bindings::DocumentBinding::DocumentReadyState;
