...
use crate::script::animation_timeline::AnimationTimeline;
use crate::script::animations::Animations;
use crate::script::document_loader::{DocumentLoader, LoadType};
use crate::script::dom::attr::Attr;
use crate::script::dom::beforeunloadevent::BeforeUnloadEvent;
use crate::script::dom::bindings::callback::ExceptionHandling;
use crate::script::dom::bindings::cell::{DomRefCell, Ref, RefMut};
use crate::script::dom::bindings::codegen::GenericBindings::BeforeUnloadEventBinding::BeforeUnloadEvent_Binding::BeforeUnloadEventMethods;
use crate::script::dom::bindings::codegen::Bindings::DocumentBinding::{
    DocumentMethods, DocumentReadyState, DocumentVisibilityState, NamedPropertyValue,
};
use crate::script::dom::bindings::codegen::Bindings::ElementBinding::ScrollLogicalPosition;
use crate::script::dom::bindings::codegen::GenericBindings::EventBinding::Event_Binding::EventMethods;
use crate::script::dom::bindings::codegen::GenericBindings::HTMLIFrameElementBinding::HTMLIFrameElement_Binding::HTMLIFrameElementMethods;
use crate::script::dom::bindings::codegen::Bindings::HTMLOrSVGElementBinding::FocusOptions;
#[cfg(any(feature = "webxr", feature = "gamepad"))]
use crate::script::dom::bindings::codegen::GenericBindings::NavigatorBinding::Navigator_Binding::NavigatorMethods;
use crate::script::dom::bindings::codegen::GenericBindings::NodeBinding::NodeMethods;
use crate::script::dom::bindings::codegen::Bindings::NodeFilterBinding::NodeFilter;
use crate::script::dom::bindings::codegen::GenericBindings::PerformanceBinding::PerformanceMethods;
use crate::script::dom::bindings::codegen::Bindings::PermissionStatusBinding::PermissionName;
use crate::script::dom::bindings::codegen::Bindings::WindowBinding::{
    FrameRequestCallback, ScrollBehavior, WindowMethods,
};
use crate::script::dom::bindings::codegen::GenericBindings::XPathEvaluatorBinding::XPathEvaluatorMethods;
use crate::script::dom::bindings::codegen::Bindings::XPathNSResolverBinding::XPathNSResolver;
use crate::script::dom::bindings::codegen::UnionTypes::{
    BooleanOrImportNodeOptions, NodeOrString, StringOrElementCreationOptions, TrustedHTMLOrString,
};
use crate::script::dom::bindings::domname::{
    self, is_valid_attribute_local_name, is_valid_element_local_name, namespace_from_domstring,
};
use crate::script::dom::bindings::error::{Error, ErrorInfo, ErrorResult, Fallible};
use crate::script::dom::bindings::frozenarray::CachedFrozenArray;
use crate::script::dom::bindings::inheritance::{Castable, ElementTypeId, HTMLElementTypeId, NodeTypeId};
use crate::script::dom::bindings::num::Finite;
use crate::script::dom::bindings::refcounted::{Trusted, TrustedPromise};
use crate::script::dom::bindings::reflector::{DomGlobal, reflect_dom_object_with_proto};
use crate::script::dom::bindings::root::{Dom, DomRoot, LayoutDom, MutNullableDom, ToLayout};
use crate::script::dom::bindings::str::{DOMString, USVString};
use crate::script::dom::bindings::trace::{HashMapTracedValues, NoTrace};
use crate::script::dom::bindings::weakref::DOMTracker;
use crate::script::dom::bindings::xmlname::matches_name_production;
use crate::script::dom::cdatasection::CDATASection;
use crate::script::dom::comment::Comment;
use crate::script::dom::compositionevent::CompositionEvent;
use crate::script::dom::css::cssstylesheet::CSSStyleSheet;
use crate::script::dom::css::fontfaceset::FontFaceSet;
use crate::script::dom::css::stylesheetlist::{StyleSheetList, StyleSheetListOwner};
use crate::script::dom::customelementregistry::{
    CustomElementDefinition, CustomElementReactionStack, CustomElementRegistry,
};
use crate::script::dom::customevent::CustomEvent;
use crate::script::dom::document_embedder_controls::DocumentEmbedderControls;
use crate::script::dom::document_event_handler::DocumentEventHandler;
use crate::script::dom::documentfragment::DocumentFragment;
use crate::script::dom::documentorshadowroot::{
    DocumentOrShadowRoot, ServoStylesheetInDocument, StylesheetSource,
};
use crate::script::dom::documenttype::DocumentType;
use crate::script::dom::domimplementation::DOMImplementation;
...
use crate::script::dom::event::{Event, EventBubbles, EventCancelable};
use crate::script::dom::eventtarget::EventTarget;
use crate::script::dom::execcommand::basecommand::DefaultSingleLineContainerName;
use crate::script::dom::execcommand::contenteditable::ContentEditableRange;
use crate::script::dom::execcommand::execcommands::DocumentExecCommandSupport;
use crate::script::dom::focusevent::FocusEvent;
use crate::script::dom::globalscope::GlobalScope;
use crate::script::dom::hashchangeevent::HashChangeEvent;
...
use crate::script::dom::html::htmlcollection::{CollectionFilter, HTMLCollection};
use crate::script::dom::html::htmlelement::HTMLElement;
use crate::script::dom::html::htmlembedelement::HTMLEmbedElement;
use crate::script::dom::html::htmlformelement::{FormControl, FormControlElementHelpers, HTMLFormElement};
...
use crate::script::dom::html::htmlscriptelement::{HTMLScriptElement, ScriptResult};
use crate::script::dom::html::htmltitleelement::HTMLTitleElement;
use crate::script::dom::htmldetailselement::DetailsNameGroups;
use crate::script::dom::intersectionobserver::IntersectionObserver;
use crate::script::dom::keyboardevent::KeyboardEvent;
use crate::script::dom::largestcontentfulpaint::LargestContentfulPaint;
use crate::script::dom::location::Location;
use crate::script::dom::messageevent::MessageEvent;
use crate::script::dom::mouseevent::MouseEvent;
use crate::script::dom::node::{Node, NodeDamage, NodeFlags, NodeTraits, ShadowIncluding};
use crate::script::dom::nodeiterator::NodeIterator;
use crate::script::dom::nodelist::NodeList;
use crate::script::dom::pagetransitionevent::PageTransitionEvent;
use crate::script::dom::performance::performanceentry::PerformanceEntry;
use crate::script::dom::performance::performancepainttiming::PerformancePaintTiming;
use crate::script::dom::processinginstruction::ProcessingInstruction;
use crate::script::dom::promise::Promise;
use crate::script::dom::range::Range;
use crate::script::dom::resizeobserver::{ResizeObservationDepth, ResizeObserver};
use crate::script::dom::scrolling_box::{ScrollAxisState, ScrollRequirement, ScrollingBox};
use crate::script::dom::selection::Selection;
use crate::script::dom::servoparser::ServoParser;
use crate::script::dom::shadowroot::ShadowRoot;
use crate::script::dom::storageevent::StorageEvent;
use crate::script::dom::text::Text;
use crate::script::dom::touchevent::TouchEvent as DomTouchEvent;
use crate::script::dom::touchlist::TouchList;
use crate::script::dom::treewalker::TreeWalker;
use crate::script::dom::trustedhtml::TrustedHTML;
use crate::script::dom::types::{HTMLCanvasElement, HTMLDialogElement, VisibilityStateEntry};
use crate::script::dom::uievent::UIEvent;
use crate::script::dom::virtualmethods::vtable_for;
use crate::script::dom::watchsocket::WatchSocket;
use crate::script::dom::websocket::WebSocket;
use crate::script::dom::window::Window;
use crate::script::dom::windowproxy::WindowProxy;
use crate::script::dom::xpathevaluator::XPathEvaluator;
use crate::script::dom::xpathexpression::XPathExpression;
use crate::script::fetch::{DeferredFetchRecordInvokeState, FetchCanceller};
use crate::script::frame_kind::FrameKind;
use crate::script::iframe_collection::IFrameCollection;
use crate::script::image_animation::ImageAnimationManager;
use crate::script::messaging::{CommonScriptMsg, MainThreadScriptMsg};
use crate::script::mime::{APPLICATION, CHARSET};
use crate::script::network_listener::{FetchResponseListener, NetworkListener};
use crate::script::realms::{AlreadyInRealm, InRealm, enter_realm};
use crate::script::script_runtime::{CanGc, ScriptThreadEventCategory};
use crate::script::script_thread::ScriptThread;
use crate::script::stylesheet_set::StylesheetSetRef;
use crate::script::task::NonSendTaskBox;
use crate::script::task_source::TaskSourceName;
use crate::script::timers::OneshotTimerCallback;
use crate::script::xpath::parse_expression;
...
impl Document {
    ...
    pub(crate) fn update_shared_selection_rects(&self, can_gc: CanGc) {
        ...
        use crate::script::dom::bindings::codegen::GenericBindings::RangeBinding::RangeMethods;
    ...
    pub(crate) fn deliver_resize_loop_error_notification(&self, can_gc: CanGc) {
        let error_info: ErrorInfo = crate::script::dom::bindings::error::ErrorInfo {
