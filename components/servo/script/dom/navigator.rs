...
use crate::script::dom::bindings::codegen::GenericBindings::NavigatorBinding::NavigatorMethods;
use crate::script::dom::bindings::codegen::GenericBindings::WindowBinding::Window_Binding::WindowMethods;
use crate::script::dom::bindings::codegen::Bindings::XMLHttpRequestBinding::BodyInit;
...
use crate::script::dom::bluetooth::Bluetooth;
use crate::script::dom::clipboard::Clipboard;
use crate::script::dom::credentialmanagement::credentialscontainer::CredentialsContainer;
use crate::script::dom::csp::{GlobalCspReporting, Violation};
#[cfg(feature = "gamepad")]
use crate::script::dom::gamepad::Gamepad;
#[cfg(feature = "gamepad")]
use crate::script::dom::gamepad::gamepadevent::GamepadEventType;
use crate::script::dom::geolocation::Geolocation;
use crate::script::dom::globalscope::GlobalScope;
use crate::script::dom::mediadevices::MediaDevices;
use crate::script::dom::mediasession::MediaSession;
use crate::script::dom::mimetypearray::MimeTypeArray;
use crate::script::dom::navigatorinfo;
use crate::script::dom::performance::performanceresourcetiming::InitiatorType;
use crate::script::dom::permissions::Permissions;
use crate::script::dom::pluginarray::PluginArray;
use crate::script::dom::serviceworkercontainer::ServiceWorkerContainer;
use crate::script::dom::servointernals::ServoInternals;
use crate::script::dom::types::UserActivation;
#[cfg(feature = "webgpu")]
use crate::script::dom::webgpu::gpu::GPU;
use crate::script::dom::window::Window;
#[cfg(feature = "webxr")]
use crate::script::dom::xrsystem::XRSystem;
use crate::script::fetch::RequestWithGlobalScope;
...
impl NavigatorMethods<crate::DomTypeHolder> for Navigator {
    ...
    fn SendBeacon(&self, url: USVString, data: Option<BodyInit>, can_gc: CanGc) -> Fallible<bool> {
        ...
        //
        // Handled in `crate::script::fetch::RequestWithGlobalScope::with_global_scope`
