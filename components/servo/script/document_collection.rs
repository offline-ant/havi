...
/// The collection of all [`Document`]s managed by the [`crate::script::script_thread::ScriptThread`].
...
impl DocumentCollection {
    ...
    /// Return the documents managed by this [`crate::script::script_thread::ScriptThread`] in the
...
///
/// [st]: crate::script::script_thread::ScriptThread
#[derive(Default)]
struct DocumentTree {
