...
use crate::script::dom::csp::{CspReporting, GlobalCspReporting, Violation};
...
use crate::script::dom::html::htmliframeelement::{HTMLIFrameElement, IframeContext};
use crate::script::dom::node::{Node, NodeTraits};
use crate::script::dom::servoparser::{ParserContext, ServoParser};
...
use crate::script::dom::windowproxy::{CreatorBrowsingContextInfo, WindowProxy};
use crate::script::dom::worklet::WorkletThreadPool;
use crate::script::dom::workletglobalscope::WorkletGlobalScopeInit;
use crate::script::fetch::FetchCanceller;
use crate::script::messaging::{
    CommonScriptMsg, MainThreadScriptMsg, MixedMessage, ScriptEventLoopSender,
    ScriptThreadReceivers, ScriptThreadSenders,
};
use crate::script::microtask::{Microtask, MicrotaskQueue};
use crate::script::mime::{APPLICATION, CHARSET, MimeExt, TEXT, XML};
use crate::script::navigation::{InProgressLoad, NavigationListener};
use crate::script::network_listener::{FetchResponseListener, submit_timing};
use crate::script::realms::{enter_auto_realm, enter_realm};
use crate::script::script_mutation_observers::ScriptMutationObservers;
use crate::script::script_runtime::{
...
use crate::script::task_queue::TaskQueue;
use crate::script::webdriver_handlers::jsval_to_webdriver;
use crate::{DomTypeHolder, webdriver_handlers};
...
impl ScriptThread {
    ...
    fn handle_navigate_iframe(
        ...
        let frame = self
            ...
            .find_frame(parent_pipeline_id, browsing_context_id);
        if let Some(frame) = frame {
            frame.navigate_or_reload_child_browsing_context(load_data, history_handling, cx);
        }
    }
