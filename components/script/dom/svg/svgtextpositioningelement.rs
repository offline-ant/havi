...
use crate::dom::bindings::codegen::Bindings::SVGTextPositioningElementBinding::SVGTextPositioningElementMethods;
use crate::dom::bindings::inheritance::Castable;
use crate::dom::bindings::reflector::DomGlobal;
use crate::dom::bindings::root::{DomRoot, MutNullableDom};
use crate::dom::document::Document;
use crate::dom::svg::svganimatedvalueobjects::{SVGAnimatedLengthList, SVGAnimatedNumberList};
...
impl SVGTextPositioningElementMethods<crate::DomTypeHolder> for SVGTextPositioningElement {
    fn X(&self) -> DomRoot<SVGAnimatedLengthList> {
        self.x.or_init(|| SVGAnimatedLengthList::new(&self.global(), self.upcast(), local_name!("x"), crate::script_runtime::CanGc::note()))
    }

    fn Y(&self) -> DomRoot<SVGAnimatedLengthList> {
        self.y.or_init(|| SVGAnimatedLengthList::new(&self.global(), self.upcast(), local_name!("y"), crate::script_runtime::CanGc::note()))
    }

    fn Dx(&self) -> DomRoot<SVGAnimatedLengthList> {
        self.dx.or_init(|| SVGAnimatedLengthList::new(&self.global(), self.upcast(), local_name!("dx"), crate::script_runtime::CanGc::note()))
    }

    fn Dy(&self) -> DomRoot<SVGAnimatedLengthList> {
        self.dy.or_init(|| SVGAnimatedLengthList::new(&self.global(), self.upcast(), local_name!("dy"), crate::script_runtime::CanGc::note()))
    }

    fn Rotate(&self) -> DomRoot<SVGAnimatedNumberList> {
        self.rotate.or_init(|| SVGAnimatedNumberList::new(&self.global(), self.upcast(), local_name!("rotate"), crate::script_runtime::CanGc::note()))
    }
}
