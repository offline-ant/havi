...
use crate::blocklist::{Blocklist, uuid_is_blocklisted};
use crate::scanfilter::{BluetoothScanfilter, BluetoothScanfilterSequence, RequestDeviceoptions};
...
pub enum BluetoothRequest {
    RequestDevice(RequestDeviceoptions, GenericCallback<BluetoothResponseResult>),
