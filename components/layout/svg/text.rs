...
fn recompute_run_rect(
    ...
    let mut bounds: Option<crate::geom::PhysicalRect<Au>> = None;
...
fn position_shaped_svg_run(
    ...
    let mut run_bounds: Option<crate::geom::PhysicalRect<Au>> = None;
...
fn glyph_bounds_rect_with_metrics(
    ...
    if rotation_degrees == 0.0 {
        return crate::geom::PhysicalRect::new(
...
mod tests {
    ...
    fn finishing_middle_chunk_shifts_runs_and_addressing() {
        ...
        state.runs.push(SVGGlyphRun {
            text: "ab".to_owned(),
            rect: crate::geom::PhysicalRect::new(
                crate::geom::PhysicalPoint::new(Au::from_f32_px(10.0), Au::zero()),
                crate::geom::PhysicalSize::new(Au::from_f32_px(20.0), Au::from_f32_px(10.0)),
            ),
            font_size_px: 12.0,
            glyphs: Vec::new(),
            font_data: None,
