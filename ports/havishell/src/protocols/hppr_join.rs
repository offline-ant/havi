...
pub struct HpprJoinHandler {
    client: Arc<HpprdClientAsync>,
    credential_store: CredentialStoreHandle,
}

impl HpprJoinHandler {
...
impl ProtocolHandler for HpprJoinHandler {
    fn load(
        &self,
        request: &mut Request,
        ...
        Box::pin(async move {
            let page = havi_protocols::pages::hppr_join::handle_request(&url_str, &client, &creds)
                .await;
