...
pub struct HpprSetupHandler {
    client: Arc<HpprdClientAsync>,
    credential_store: CredentialStoreHandle,
}

impl HpprSetupHandler {
...
impl ProtocolHandler for HpprSetupHandler {
    fn load(
        &self,
        request: &mut Request,
        ...
        Box::pin(async move {
            let page =
                havi_protocols::pages::hppr_setup::handle_request(&url_str, &client, &creds).await;
